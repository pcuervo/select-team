            ...
            <form role="form" class="[ j-contact-message ]">
                <div class="form-group">
                    <?php if (qtrans_getLanguage() == 'es'){ ?>
                        ...
                        <input type="text" class="[ form-control ][ required ]" id="name" placeholder="Nombre">
                    <?php } else { ?>
                ...
                <div class="form-group">
                    <?php if (qtrans_getLanguage() == 'es'){ ?>
                        ...
                        <input type="email" class="[ form-control ][ required email ]" id="mail" placeholder="Ingresa tu correo electrónico">
                    <?php } else { ?>
                        <label for="mail">E-mail address</label>
                        <input type="email" class="[ form-control ][ required email ]" id="mail" placeholder="Enter email">
                    <?php } ?>
                </div>
                <div class="form-group">
                    <?php if (qtrans_getLanguage() == 'es'){ ?>
