                        ...
                        <form role="form" class="[ row ] [ j-form-message-advisor ]" onsubmit="validateMessageAdvisor()">
                            <div class="[ form-group ] [ col-xs-12 ]">
                                <?php if (qtrans_getLanguage() == 'es'){ ?>
                                    ...
                                    <select class="[ form-control ] [ selectMensajeAdvisor ]" id="selectMensajeAdvisor">
                            ...
                            <div class="[ form-group ] [ col-xs-12 ]">
                                ...
                                <?php } ?>
                                <textarea class="[ form-control ] [ txtareaMensajeAdvisor ]" rows="3" id="txtareaMensajeAdvisor"></textarea>
                            </div>
                            <?php if (qtrans_getLanguage() == 'es'){ ?>
